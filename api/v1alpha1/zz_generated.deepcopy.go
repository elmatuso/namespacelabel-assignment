...
func (in *FailedLabel) DeepCopyInto(out *FailedLabel) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FailedLabel.
func (in *FailedLabel) DeepCopy() *FailedLabel {
	if in == nil {
		return nil
	}
	out := new(FailedLabel)
...
func (in *NamespaceLabelStatus) DeepCopyInto(out *NamespaceLabelStatus) {
	*out = *in
	...
	if in.FailedLabels != nil {
		in, out := &in.FailedLabels, &out.FailedLabels
		*out = make([]FailedLabel, len(*in))
		copy(*out, *in)
	}
}
